...
let create_footer = () => {
    ...
    '<div class="keyboard-glossary ltx_page_content"> \
        ...
        <ul> \
            ...
            <li>You can also highlight any text via mouse or via keyboard for screen-reader users and use the "Open Issue" button that will display near your cursor to report on the preceding paragraph.</li> \
        </ul> \
