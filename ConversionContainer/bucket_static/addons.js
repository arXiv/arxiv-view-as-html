...
let create_header = () => {
    ...
    var Links = `
        <div style="display: inline-flex; align-items: center;">
            ...
            ${id === 'submission' ? '' : `<a class="ar5iv-footer-button hover-effect" style="color: white;" href="https://arxiv.org/latexml/${window.location.href.match(/https:\/\/.+\/html\/(.+)/)[1]}">Back to Abstract</a>`}
      ...
      <img alt="logo" class="logomark" role="presentation" style="background-color: transparent; margin-left:40px;"
        ...
        <div class='subcontainer-fluid'>
          ...
          <!-- <a class="nav-link ar5iv-footer-button hover-effect" style="color: white; display:inline-flex; flex-direction: column; align-items:center; text-align:center" href="#"> -->
            <a class="nav-link ar5iv-footer-button hover-effect" style="color: white; margin-right:0em;" href="https://arxiv.org/latexml/${window.location.href.match(/https:\/\/.+\/html\/(.+)/)[1]}">
